...
const CountdownMannet: React.FunctionComponent<CountdownProps> = (props) => {
  ...
  return (
    <div className={'flex items-center text-white gap-2'}>
      <div>
        ...
        <div
          className={
            'BoxCountDown w-[68px] h-[68px] sm:w-[120px] sm:h-[116px] bg-[#FFFFFF1A] flex items-center justify-center'
          }
        >
          <div className={'text-center'}>
            <div className={'font-bold text-2xl sm:text-5xl text-[#fff] dark:text-white'}>{time_left.days}</div>
      ...
      <div>
        ...
        >
          <div className={'text-center'}>
            <div className={'font-bold text-2xl sm:text-5xl text-[#fff] dark:text-white'}>{time_left.hours}</div>
      ...
      <div>
        ...
        >
          <div className={'text-center'}>
            <div className={'font-bold text-2xl sm:text-5xl text-[#fff] dark:text-white'}>{time_left.minutes}</div>
      ...
      <div>
        ...
        >
          <div className={'text-center'}>
            <div className={'font-bold text-2xl sm:text-5xl text-[#fff] dark:text-white'}>{time_left.seconds}</div>
...
export default CountdownMannet;
